...
PYBIND11_MODULE(elastic_knots, m) {
    ...
    spring
        ...
        .def("lengthEnergy", &Spring::length_energy)
        ...
        .def("dE_dL", &Spring::dE_dL)
        .def("dElength_dL", &Spring::dElength_dL)
        .def("dEreg_dL", &Spring::dEreg_dL)
        ...
        .def("minLenEnergy", &Spring::min_length_energy)
        .def("minLenGradient", &Spring::min_length_gradient)
